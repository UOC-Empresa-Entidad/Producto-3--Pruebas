    ...
    <body>
       <!-- Abrimos div contenedor de bootstrap para la rejilla (grid) -->
        ...
        <?php
			...
			$query="SELECT p8.producto.producto FROM p8.producto, p8.categoria WHERE p8.categoria.Categoria=1 AND p8.categoria.producto=p8.producto.IdProducto";
		...
		?>
                   ...
                   <!--<div id="lista">
                   	...
                   	<a href="detalle.php" style="text-decoration: none"><p><img src="img/boton_azul.jpg" width="25" height="25"/>&nbsp &nbsp Producto 1 comics</p></a><br>
                   	<a href="detalle.php" style="text-decoration: none"><p><img src="img/boton_azul.jpg" width="25" height="25"/>&nbsp &nbsp Producto 2 comics</p></a><br>
                   	<a href="detalle.php" style="text-decoration: none"><p><img src="img/boton_azul.jpg" width="25" height="25"/>&nbsp &nbsp Producto 3 comics</p></a>
